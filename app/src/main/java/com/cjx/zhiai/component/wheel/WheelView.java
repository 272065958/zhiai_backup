...
public class WheelView extends View {
	...
	/** Current value & label text color 选中颜色 */
	private static final int VALUE_TEXT_COLOR = 0xFF3A3A3A;

	/** Items text color未选中颜色 */
	private static final int ITEMS_TEXT_COLOR = 0xFFA2A2A2;
	...
	// Scrolling
	private boolean isScrollingPerformed, canScroll = true;
...
//		centerDrawable.draw(canvas);
		canvas.drawLine(0, center - offset, getWidth(), center
				- offset, paint);
		canvas.drawLine(0, center + offset, getWidth(), center
				+ offset, paint);
	}
