...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected int[] itemdrawables = {R.drawable.ease_chat_takepic_selector, R.drawable.ease_chat_image_selector,
            R.drawable.ease_chat_location_selector, R.drawable.ease_chat_voice_selector, R.drawable.ease_chat_video_selector};
    protected int[] itemIds = {ITEM_TAKE_PICTURE, ITEM_PICTURE, ITEM_LOCATION, ITEM_VOICE, ITEM_VIDEO};
        ...
        public void onClick(int itemId, View view) {
            ...
            switch (itemId) {
                ...
                case ITEM_LOCATION:
                    ...
                    break;
                case ITEM_VOICE:
                    if(onChatMenuClick != null){
                        onChatMenuClick.startVoiceCall(toChatUsername);
                    }
                    break;
                case ITEM_VIDEO:
                    if(onChatMenuClick != null){
                        onChatMenuClick.startVideoCall(toChatUsername);
                    }
                    break;
                default:
                    break;
    ...
    public void setOnChatMenuClickListener(OnChatMenuClick onChatMenuClick){
        this.onChatMenuClick = onChatMenuClick;
    }

    public interface OnChatMenuClick{
        void startVoiceCall(String toChatUsername);
        void startVideoCall(String toChatUsername);
    }
